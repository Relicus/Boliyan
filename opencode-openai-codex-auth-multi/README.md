...
[![Tests](https://github.com/numman-ali/opencode-openai-codex-auth-multi/actions/workflows/ci.yml/badge.svg)](https://github.com/numman-ali/opencode-openai-codex-auth-multi/actions)
...
```
Run `opencode auth login` again to add more accounts for rotation.
...
Uninstall:
```bash
npx -y opencode-openai-codex-auth-multi@latest --uninstall
npx -y opencode-openai-codex-auth-multi@latest --uninstall --all
```
---
## 📦 Models
...
- Multi-account rotation with sticky/round-robin/hybrid strategies
---
## 📚 Docs
