# OpenCode OpenAI Codex Auth Multi Plugin
...
- [Release Notes](https://github.com/numman-ali/opencode-openai-codex-auth-multi/releases) - Version history and updates
