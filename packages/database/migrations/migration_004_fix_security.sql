...
-- Logic: Open public access. Detailed filtering (like 'hidden' auction mode) should be handled 
-- by the application query or specific view filters, but at a row level, listings are public data.
